...
var translations = {
  tr: {
    ...
    'setup.taglineDn': 'Bu akşam sadece ikiniz için',
    'setup.everydayDn': 'Hafif Kaçamak',
    'setup.chefDn': 'Özel Menü',
    'setup.startDn': 'GECEYİ BAŞLAT',
    'pack.classic': 'Klasik',
    'pack.datenight': 'Date Night',
    'pack.lockedTitle': 'Date Night Paketi',
    'pack.lockedMsg': 'Çok yakında! Romantik tema, çiftlere özel görevler ve mum ışığında sofra finali.',
    'pack.lockedOk': 'Tamam',
    'drawer.packs': 'Paketler',
    'pack.free': 'Ücretsiz',
    'pack.owned': 'Sende',
    'pack.dnPrice': '₺99,99',
    'pack.party': 'Party',
    'pack.soon': 'Yakında',
    'pack.partySoonMsg': 'Party Modu (3-6 kişi) üzerinde çalışıyoruz — çok yakında!',
    'store.dnTitle': 'Date Night Paketi',
    'store.dnTag': 'Mutfakta romantik bir gece',
    'store.b1': '65+ çiftlere özel romantik görev',
    'store.b2': 'Mum ışığı teması ve özel karakterler',
    'store.b3': 'Kıvılcım görevleri ve sofra finali',
    'store.b4': 'Bir kez al, sonsuza dek senin',
    'store.buy': 'Kilidini Aç — ₺99,99',
    'store.owned': 'Bu paket sende',
    'store.play': 'Date Night Oyna',
    'store.restore': 'Satın alımı geri yükle',
    'store.restoreSoon': 'Geri yükleme, satın alma sistemiyle birlikte aktif olacak.',
    'store.buySoon': 'Satın alma çok yakında aktif! Şimdilik paket önizleme olarak açık.',
    'store.partyTitle': 'Party Modu',
    'res.upsellTitle': 'Bir dahaki sefere: Date Night',
    'res.upsellSub': 'Mutfakta romantik bir gece sizi bekliyor',
    ...
    'trans.titleDn': 'Geceniz Hazırlanıyor',
    'trans.dn1': 'Mumlar yakılıyor...',
    'trans.dn2': 'Menü ikinize özel yazılıyor...',
    'trans.dn3': 'Masa kuruluyor...',
    'trans.dn4': 'Domates ve soğan dansa kalkıyor...',
    'trans.dn5': 'Gül yaprakları serpiliyor...',
    ...
    'res.badgeBraveSub': 'Şef modu!',
    'res.badgeFastHands': 'Hızlı Eller',
    'res.badgeFastSub': 'Gündelik mod!',
    'res.badgePerfect': 'Kusursuz',
    'res.badgePerfectSub': 'Tüm adımlar bitti',
    'res.titleDn': 'Şerefe!',
    'res.subtitleDn': '{cook} & {challenger} — unutulmaz bir gece!',
    'review.title': 'Eğlendiniz mi?',
    'review.message': 'Cooking Challenge hoşunuza gittiyse mağazada puanlamanız bize çok güç katar. Sadece 10 saniye sürer!',
    'review.rate': 'Puanla',
    'review.later': 'Daha Sonra',
  ...
  en: {
    ...
    'setup.taglineDn': 'Tonight, just the two of you',
    'setup.everydayDn': 'Sweet & Simple',
    'setup.chefDn': 'Special Menu',
    'setup.startDn': 'START THE NIGHT',
    'pack.classic': 'Classic',
    'pack.datenight': 'Date Night',
    'pack.lockedTitle': 'Date Night Pack',
    'pack.lockedMsg': 'Coming soon! Romantic theme, couple challenges and a candlelit table finale.',
    'pack.lockedOk': 'OK',
    'drawer.packs': 'Packs',
    'pack.free': 'Free',
    'pack.owned': 'Owned',
    ...
    'pack.party': 'Party',
    'pack.soon': 'Soon',
    'pack.partySoonMsg': 'Party Mode (3-6 players) is in the works — coming soon!',
    'store.dnTitle': 'Date Night Pack',
    'store.dnTag': 'A romantic night in the kitchen',
    'store.b1': '65+ romantic challenges made for couples',
    'store.b2': 'Candlelight theme and exclusive characters',
    'store.b3': 'Spark challenges and a candlelit table finale',
    'store.b4': 'Buy once, yours forever',
    'store.buy': 'Unlock — $4.99',
    'store.owned': 'You own this pack',
    'store.play': 'Play Date Night',
    'store.restore': 'Restore purchase',
    'store.restoreSoon': 'Restore will be available together with purchases.',
    'store.buySoon': 'Purchases are coming very soon! The pack is open as a preview for now.',
    'store.partyTitle': 'Party Mode',
    'res.upsellTitle': 'Next time: Date Night',
    'res.upsellSub': 'A romantic night in the kitchen awaits',
    ...
    'trans.titleDn': 'Preparing Your Night',
    'trans.dn1': 'Lighting the candles...',
    'trans.dn2': 'Writing a menu just for you two...',
    'trans.dn3': 'Setting the table...',
    'trans.dn4': 'The tomato asks the onion to dance...',
    'trans.dn5': 'Scattering rose petals...',
    ...
    'res.badgeBraveSub': 'Chef mode!',
    'res.badgeFastHands': 'Fast Hands',
    'res.badgeFastSub': 'Everyday mode!',
    'res.badgePerfect': 'Perfectionist',
    'res.badgePerfectSub': 'All steps done!',
    'res.titleDn': 'Cheers!',
    'res.subtitleDn': '{cook} & {challenger} — a night to remember!',
    'review.title': 'Enjoying the game?',
    'review.message': 'If Cooking Challenge made your kitchen more fun, a store rating would mean the world to us. It only takes 10 seconds!',
